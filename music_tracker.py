...
# Пошукові запити до YouTube. УВАГА щодо квоти: кожен search.list коштує
# 100 одиниць квоти, воркфлоу запускається 4 рази на добу, а денна квота
# YouTube Data API = 10 000 одиниць. Тобто: len(SEARCH_QUERIES) * 100 * 4
# має лишатися помітно нижче 10 000. 20 запитів => 8 000/добу + trending і
# деталі відео (~50) => ~8 050/добу. Не додавай надто багато нових запитів,
# інакше квота вичерпається і бот перестане знаходити відео.
SEARCH_QUERIES = [
    'новая песня 2026',
    'новая русская песня 2026',
    'новый российский хит 2026',
    'новинки российской музыки 2026',
    'новая музыка россия 2026',
    'премьера песни 2026 россия',
    'премьера клипа 2026 россия',
    'новый клип 2026 россия',
    'русский поп новинка 2026',
    'русский рэп новинка 2026',
    'новый трек 2026 россия',
    'русские хиты 2026',
    'топ русских песен 2026',
    'новинки музыки 2026 русские',
    'новый сингл 2026 россия',
    'свежая музыка россия 2026',
    'российская попса новинка 2026',
    'новый альбом россия 2026',
    'новинки рэпа россия 2026',
    'новый хит россия',
]
...
def main():
    ...
    # Щоденне сповіщення про хіти — раз на день. Лише пісні, що набирають
    # від VIEWS_PER_DAY_THRESHOLD (50 000) переглядів/день. Дедуплікація —
    # через notified.
    if last_notif.get('date') == today:
        ...
        for h in rising:
            if h['id'] in sent_ids:
                notified[h['id']] = today
                weekly_songs.pop(h['id'], None)  # хіт більше не кандидат на суботу
        ...
        if len(sent_ids) == len(rising):
            last_notif['date'] = today
        print(f"Надіслано {len(sent_ids)}/{len(rising)} щоденних хітів.")
    else:
        print("Щоденних хітів немає (жодна пісня не досягла порога).")
